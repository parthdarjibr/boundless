...
namespace UnityEngine.EventSystems
{
    public class OVRInputModule : PointerInputModule
    {
		...
		[Tooltip("Invert Y axis on touchpad")]
		public bool InvertSwipeYAxis = true;
...
#region PointerEventData pool
        ...
        virtual protected MouseState GetGazePointerData()
        {
            ...
            if (ovrRaycaster) 
            {
				...
				/*
				// EDIT PARTH
				leftData.position = ovrRaycaster.GetScreenPositionCUI(raycast);
				// ---
				*/
                ...
                if (graphicRect != null)
                {
					...
					Vector3 worldPos = s.CanvasToCurvedCanvas (raycast.worldPosition);
					Vector3 normal = s.CanvasToCurvedCanvasNormal (graphicRect.localPosition);
					// ---
					*/
