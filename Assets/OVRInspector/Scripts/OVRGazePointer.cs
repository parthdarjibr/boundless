...
public class OVRGazePointer : MonoBehaviour {
    ...
    public float depthScaleMultiplier = 0.01f;
	...
	public void ShowLoadingReticle() {
		// Change color of reticle
		quadObject.GetComponent<Renderer>().material.SetColor("_TintColor", new Color32(175, 0, 0, 128));
	...
	public void HideLoadingReticle() {
		// Change color of reticle
		quadObject.GetComponent<Renderer>().material.SetColor("_TintColor", new Color32(128, 128, 128, 128));
