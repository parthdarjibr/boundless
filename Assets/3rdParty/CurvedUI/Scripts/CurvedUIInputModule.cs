...
#pragma warning disable 414, 0649 // this is just so we wont get "unused variable" code warnings when compiling with different platform defines
	...
	// EDIT PARTH
	// SCROLL VARIABLES USED BY RAYCASTER
	public bool useSwipeScroll = true;
    public OVRInput.Button customControllerSwipeUp;
    public OVRInput.Button customControllerSwipeDown;
...
#pragma warning restore 414, 0649
		...
		case CurvedUIController.CUSTOM_RAY:
			{
                    ...
                    CustromControllerButtonDown = OVRInput.GetDown(InteractionButton) || OVRInput.GetDown(OVRInput.Button.One);
    ...
    #region PROCESS OCULUS TOUCH

    protected virtual void ProcessOculusTouch()
    {
	...
	CustromControllerButtonDown = OVRInput.GetDown(InteractionButton, OVRInput.Controller.RTouch);
...
#region SETTERS AND GETTERS
	...
	/// <summary>
	/// The current transform for custom controller.
	/// </summary>
	/// <value>The custom controller transform.</value>
	public static Transform CustomControllerTransform {
		get { return Instance.customControllerTransform; }
		set { Instance.customControllerTransform = value; }
	}
    ...
    /// <summary>
    /// Custom controller interaction button
    /// </summary>
    public OVRInput.Button CustomControllerInteractionButton
    {
        get
        {
    ...
    /// <summary>
    /// Custom controller swipe up interaction
    /// </summary>
    public OVRInput.Button CustomControllerSwipeDown
    {
        get
        {
            return customControllerSwipeDown;
        }
        set
        {
            customControllerSwipeDown = value;
        }
    }
    ...
    public OVRInput.Button CustomControllerSwipeUp
    {
        get
        {
            return customControllerSwipeUp;
        }
        set
        {
            customControllerSwipeUp = value;
        }
    }
#if CURVEDUI_VIVE
        /// <summary>
